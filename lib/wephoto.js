  ...
  reader.onload = function() {
    ...
    img.onload = function() {
      ...
      */
      ...
      ctx.fillText(url.substring(0, 63), 120, h-20);
      ctx.fillText(url.substring(64, 255), 120, h-10);
      ...
      res.then( function(data) {
        ...
        var dtqr = ctxqr.getImageData(0,0,116,116);
        ctx.putImageData(dtqr,0,h-116);
