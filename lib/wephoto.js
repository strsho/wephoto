  ...
  reader.onload = function() {
    ...
    img.onload = function() {
      ...
      */
      ...
      var url = urlbase + "&ll=" + lat + "," + lng; // + "&q=" + encodeURIComponent(msg.value);
      link.href = url;
      link.innerText = url;
      ...
      ctx.fillText(url.substring(0, 63), 84, h-20);
      ctx.fillText(url.substring(64, 255), 84, h-10);
      ...
      res.then( function(data) {
        ...
        var dtqr = ctxqr.getImageData(0,0,80,80);
        ctx.putImageData(dtqr,0,h-80);
